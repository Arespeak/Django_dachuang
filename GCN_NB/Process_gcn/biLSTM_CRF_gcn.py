...
from GCN_NB.Process_gcn.data_processing import batch_iter, process
...
class biLstm_crf_gcn(object):
    ...
    def bils_crf(self):
        ...
        def build_gcn(self, input_shape):
            ...
            self.wei = self.add_variable(name='wei', shape=[features_dim, self.out_dim],
